...
from .app import MaxMindGeolocationService
...
logging_config_path = os.path.join(config_dir, MaxMindGeolocationService.LOGGING_CONFIG_FILE)
...
with MaxMindGeolocationService(sys.argv[1]) as app:
    try:
        # Run the application
        app.run()
        running = True
