...
RELEASE_NAME = "dxlmaxmindservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlmaxmindservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlmaxmindservice")])
...
print("\nRemoving dxlmaxmindservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlmaxmindservice.egg-info"))
